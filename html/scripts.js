...
var nbPossibleQuestions = 9; // number of questions in database questions.js
var lastClick = 0;
...
function openQuestionnaire() {
	...
	$("#questionNumero").html(questionNumber);
...
$(".btnQuestion").click(function () {
	$.post('http://xex_pilotschool/question', JSON.stringify({}));
});

$(".btnClose").click(function () {
	$.post('http://xex_pilotschool/close', JSON.stringify({}));
	userAnswer = [];
	goodAnswer = [];
	questionUsed = [];
	questionNumber = 1;
...
$(".btnKick").click(function () {
	$.post('http://xex_pilotschool/kick', JSON.stringify({}));
	userAnswer = [];
	goodAnswer = [];
	questionUsed = [];
	questionNumber = 1;
